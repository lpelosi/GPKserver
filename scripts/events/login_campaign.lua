...
local loginCampaignStart  = { year = 2025, month = 11, day = 1, hour = 0 }
local loginCampaignEnd    = { year = 2025, month = 10, day = 31, hour = 23 }
local loginCampaignRedeem = { year = 2025, month = 11, day = 1, hour = 0 }
