...
-- Structure:                 [spellId] = { Tier, Main Effect,      subEffect,                Main Modifier,          Merit Effect,             Job-Point Effect,     power Sreq Pcap Mult Div SVP },
    ...
    -- Aria of Passion (GPK: Prime harp Loughnashade song) -- party Physical Damage Limit +% (DAMAGE_LIMITP)
    [xi.magic.spell.ARIA_OF_PASSION   ] = { 1, xi.effect.ARIA,      0,                        xi.mod.ALL_SONGS_EFFECT, 0,                        0,                 2000,   0, 2210,  0,  1, true  },
