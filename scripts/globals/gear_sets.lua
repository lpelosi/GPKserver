...
local gearSets =
{
    ...
    [57] = -- Samurai 109/119 af3
    {
        items =
        {
            ...
            xi.item.KASUGA_DOMARU_P2,
            xi.item.KASUGA_DOMARU_P3,
            xi.item.KASUGA_HAIDATE,
            xi.item.KASUGA_HAIDATE_P1,
            xi.item.KASUGA_HAIDATE_P2,
            xi.item.KASUGA_HAIDATE_P3,
            xi.item.KASUGA_KABUTO,
            xi.item.KASUGA_KABUTO_P1,
            xi.item.KASUGA_KABUTO_P2,
            xi.item.KASUGA_KABUTO_P3,
            xi.item.KASUGA_KOTE,
            xi.item.KASUGA_KOTE_P1,
            xi.item.KASUGA_KOTE_P2,
            xi.item.KASUGA_KOTE_P3,
            xi.item.KASUGA_SUNE_ATE,
            xi.item.KASUGA_SUNE_ATE_P1,
            xi.item.KASUGA_SUNE_ATE_P2,
            xi.item.KASUGA_SUNE_ATE_P3,
        },
        minEquipped = 2,
        mods =
        {
    ...
    [58] = -- MNK 109/119 af3
    {
        items =
        {
            ...
            xi.item.BHIKKU_GAITERS_P2,
            xi.item.BHIKKU_GAITERS_P3,
            xi.item.BHIKKU_HOSE,
            xi.item.BHIKKU_HOSE_P1,
            xi.item.BHIKKU_HOSE_P2,
            xi.item.BHIKKU_HOSE_P3,
            xi.item.BHIKKU_GLOVES,
            xi.item.BHIKKU_GLOVES_P1,
            xi.item.BHIKKU_GLOVES_P2,
            xi.item.BHIKKU_GLOVES_P3,
            xi.item.BHIKKU_CYCLAS,
            xi.item.BHIKKU_CYCLAS_P1,
            xi.item.BHIKKU_CYCLAS_P2,
            xi.item.BHIKKU_CYCLAS_P3,
            xi.item.BHIKKU_CROWN,
            xi.item.BHIKKU_CROWN_P1,
            xi.item.BHIKKU_CROWN_P2,
            xi.item.BHIKKU_CROWN_P3,
        },
        minEquipped = 2,
        mods =
        {
    ...
    [59] = -- 109/119 WAR AF3
    {
        items =
        {
            ...
            xi.item.BOII_MASK_P2,
            xi.item.BOII_MASK_P3,
            xi.item.BOII_CALLIGAE,
            xi.item.BOII_CALLIGAE_P1,
            xi.item.BOII_CALLIGAE_P2,
            xi.item.BOII_CALLIGAE_P3,
            xi.item.BOII_CUISSES,
            xi.item.BOII_CUISSES_P1,
            xi.item.BOII_CUISSES_P2,
            xi.item.BOII_CUISSES_P3,
            xi.item.BOII_MUFFLERS,
            xi.item.BOII_MUFFLERS_P1,
            xi.item.BOII_MUFFLERS_P2,
            xi.item.BOII_MUFFLERS_P3,
            xi.item.BOII_LORICA,
            xi.item.BOII_LORICA_P1,
            xi.item.BOII_LORICA_P2,
            xi.item.BOII_LORICA_P3,
        },
        minEquipped = 2,
        mods =
        {
    ...
    [60] = -- 109/119 THF AF3
    {
        items =
        {
            ...
            xi.item.SKULKERS_BONNET_P2,
            xi.item.SKULKERS_BONNET_P3,
            xi.item.SKULKERS_POULAINES,
            xi.item.SKULKERS_POULAINES_P1,
            xi.item.SKULKERS_POULAINES_P2,
            xi.item.SKULKERS_POULAINES_P3,
            xi.item.SKULKERS_CULOTTES,
            xi.item.SKULKERS_CULOTTES_P1,
            xi.item.SKULKERS_CULOTTES_P2,
            xi.item.SKULKERS_CULOTTES_P3,
            xi.item.SKULKERS_ARMLETS,
            xi.item.SKULKERS_ARMLETS_P1,
            xi.item.SKULKERS_ARMLETS_P2,
            xi.item.SKULKERS_ARMLETS_P3,
            xi.item.SKULKERS_VEST,
            xi.item.SKULKERS_VEST_P1,
            xi.item.SKULKERS_VEST_P2,
            xi.item.SKULKERS_VEST_P3,
        },
        minEquipped = 2,
        mods =
        {
    ...
    [61] = -- 109/119 RNG AF3
    {
        items =
        {
            ...
            xi.item.AMINI_CABAN_P2,
            xi.item.AMINI_CABAN_P3,
            xi.item.AMINI_GAPETTE,
            xi.item.AMINI_GAPETTE_P1,
            xi.item.AMINI_GAPETTE_P2,
            xi.item.AMINI_GAPETTE_P3,
            xi.item.AMINI_BOTTILLONS,
            xi.item.AMINI_BOTTILLONS_P1,
            xi.item.AMINI_BOTTILLONS_P2,
            xi.item.AMINI_BOTTILLONS_P3,
            xi.item.AMINI_BRAGUE,
            xi.item.AMINI_BRAGUE_P1,
            xi.item.AMINI_BRAGUE_P2,
            xi.item.AMINI_BRAGUE_P3,
            xi.item.AMINI_GLOVELETTES,
            xi.item.AMINI_GLOVELETTES_P1,
            xi.item.AMINI_GLOVELETTES_P2,
            xi.item.AMINI_GLOVELETTES_P3,
        },
        minEquipped = 2,
        mods =
        {
    ...
    [62] = -- 109/119 PLD AF3
    {
        items =
        {
            ...
            xi.item.CHEVALIERS_CUIRASS_P2,
            xi.item.CHEVALIERS_CUIRASS_P3,
            xi.item.CHEVALIERS_ARMET,
            xi.item.CHEVALIERS_ARMET_P1,
            xi.item.CHEVALIERS_ARMET_P2,
            xi.item.CHEVALIERS_ARMET_P3,
            xi.item.CHEVALIERS_SABATONS,
            xi.item.CHEVALIERS_SABATONS_P1,
            xi.item.CHEVALIERS_SABATONS_P2,
            xi.item.CHEVALIERS_SABATONS_P3,
            xi.item.CHEVALIERS_GAUNTLETS,
            xi.item.CHEVALIERS_GAUNTLETS_P1,
            xi.item.CHEVALIERS_GAUNTLETS_P2,
            xi.item.CHEVALIERS_GAUNTLETS_P3,
            xi.item.CHEVALIERS_CUISSES,
            xi.item.CHEVALIERS_CUISSES_P1,
            xi.item.CHEVALIERS_CUISSES_P2,
            xi.item.CHEVALIERS_CUISSES_P3,
        },
        minEquipped = 2,
        mods =
        {
    ...
    [63] = -- 109/119 NIN AF3
    {
        items =
        {
            ...
            xi.item.HATTORI_NINGI_P2,
            xi.item.HATTORI_NINGI_P3,
            xi.item.HATTORI_ZUKIN,
            xi.item.HATTORI_ZUKIN_P1,
            xi.item.HATTORI_ZUKIN_P2,
            xi.item.HATTORI_ZUKIN_P3,
            xi.item.HATTORI_TEKKO,
            xi.item.HATTORI_TEKKO_P1,
            xi.item.HATTORI_TEKKO_P2,
            xi.item.HATTORI_TEKKO_P3,
            xi.item.HATTORI_HAKAMA,
            xi.item.HATTORI_HAKAMA_P1,
            xi.item.HATTORI_HAKAMA_P2,
            xi.item.HATTORI_HAKAMA_P3,
            xi.item.HATTORI_KYAHAN,
            xi.item.HATTORI_KYAHAN_P1,
            xi.item.HATTORI_KYAHAN_P2,
            xi.item.HATTORI_KYAHAN_P3,
        },
        minEquipped = 2,
        mods =
        {
    ...
    [64] = -- 109/119 COR AF3
    {
        items =
        {
            ...
            xi.item.CHASSEURS_BOTTES_P2,
            xi.item.CHASSEURS_BOTTES_P3,
            xi.item.CHASSEURS_TRICORNE,
            xi.item.CHASSEURS_TRICORNE_P1,
            xi.item.CHASSEURS_TRICORNE_P2,
            xi.item.CHASSEURS_TRICORNE_P3,
            xi.item.CHASSEURS_FRAC,
            xi.item.CHASSEURS_FRAC_P1,
            xi.item.CHASSEURS_FRAC_P2,
            xi.item.CHASSEURS_FRAC_P3,
            xi.item.CHASSEURS_GANTS,
            xi.item.CHASSEURS_GANTS_P1,
            xi.item.CHASSEURS_GANTS_P2,
            xi.item.CHASSEURS_GANTS_P3,
            xi.item.CHASSEURS_CULOTTES,
            xi.item.CHASSEURS_CULOTTES_P1,
            xi.item.CHASSEURS_CULOTTES_P2,
            xi.item.CHASSEURS_CULOTTES_P3,
        },
        minEquipped = 2,
        mods =
        {
    ...
    [65] = -- 109/119 SCH AF3
    {
        items =
        {
            ...
            xi.item.ARBATEL_PANTS_P2,
            xi.item.ARBATEL_PANTS_P3,
            xi.item.ARBATEL_LOAFERS,
            xi.item.ARBATEL_LOAFERS_P1,
            xi.item.ARBATEL_LOAFERS_P2,
            xi.item.ARBATEL_LOAFERS_P3,
            xi.item.ARBATEL_BONNET,
            xi.item.ARBATEL_BONNET_P1,
            xi.item.ARBATEL_BONNET_P2,
            xi.item.ARBATEL_BONNET_P3,
            xi.item.ARBATEL_GOWN,
            xi.item.ARBATEL_GOWN_P1,
            xi.item.ARBATEL_GOWN_P2,
            xi.item.ARBATEL_GOWN_P3,
            xi.item.ARBATEL_BRACERS,
            xi.item.ARBATEL_BRACERS_P1,
            xi.item.ARBATEL_BRACERS_P2,
            xi.item.ARBATEL_BRACERS_P3,
        },
        minEquipped = 2,
        mods =
        {
    ...
    [66] = -- 109/119 WHM AF3
    {
        items =
        {
            ...
            xi.item.EBERS_PANTALOONS_P2,
            xi.item.EBERS_PANTALOONS_P3,
            xi.item.EBERS_DUCKBILLS,
            xi.item.EBERS_DUCKBILLS_P1,
            xi.item.EBERS_DUCKBILLS_P2,
            xi.item.EBERS_DUCKBILLS_P3,
            xi.item.EBERS_CAP,
            xi.item.EBERS_CAP_P1,
            xi.item.EBERS_CAP_P2,
            xi.item.EBERS_CAP_P3,
            xi.item.EBERS_BLIAUD,
            xi.item.EBERS_BLIAUD_P1,
            xi.item.EBERS_BLIAUD_P2,
            xi.item.EBERS_BLIAUD_P3,
            xi.item.EBERS_MITTS,
            xi.item.EBERS_MITTS_P1,
            xi.item.EBERS_MITTS_P2,
            xi.item.EBERS_MITTS_P3,
        },
        minEquipped = 2,
        mods =
        {
